...
#fields
fields = ['ae_job_id', 'name', 'number', 'notes', 'company_id', 'contact_id', 'date_in', 'xxtime_in', 'due_date', 'job_status_id', 'employee_project_manager_id', 'employee_production_id', 'address_line_1', 'address_line_2', 'city', 'state', 'zip', 'layout_id', 'number_of_copies', 'time_of_day_shot', 'project_manager_hour', 'mileage', 'production_hour', 'nov', 'xxxbllin_status', 'job_description', 'carrier_id', 'v1_description', 'v2_description', 'v3_description', 'v4_description', 'v5_description', 'v6_description', 'v7_description', 'v8_description', 'v9_description', 'v10_description', 'xxcontact2', 'xxcontact2_prints', 'xxtrans_desc', 'xxactive', 'xxdate_finished', 'billing_note', 'billing_to_company_id', 'billing_to_contact_id', 'price', 'invoice_number', 'job_type_id', 'job_history', 'handling_id', 'travel_id']

project_fields = ['ae_job_id', 'name', 'number', 'address_line_1', 'address_line_2', 'city', 'state', 'zip', 'company_id', 'contact_id', 'date_in', 'due_date', 'job_status_id', 'production_hour', 'mileage', 'employee_project_manager_id', 'employee_production_id', 'project_manager_hour', 'job_type_id', 'handling_id', 'travel_id', 'billing_note', 'billing_to_company_id', 'billing_to_contact_id', 'price', 'invoice_number',  'job_history']

jobchecklist_fields = ['ae_job_id', 'project_id', 'carrier_id', 'employee_project_manager_id', 'job_description', 'number_of_copies', 'layout_id']
...
view_jobchecklist_records.each do |r|
  1.upto(10) do |i|
    unless r["v#{i}_description".to_sym].blank?
      ...
      view_jobchecklist.notes = r[:notes] if i == 1
